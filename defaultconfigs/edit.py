...
parser.add_argument("--glob", default="tfc-server.toml", help="File glob (default **/*.json)")
parser.add_argument("--dry-run", action="store_true", help="Don't write files, just show changes")
args = parser.parse_args()

pattern = re.compile(r'(GestationDays = )(-?\d+(?:\.\d+)?)', re.IGNORECASE)
